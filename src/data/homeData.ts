...
export const solutionScenes = ref([
  {
    ...
    link: '/homeCoreIndustries?module=city-fire',
  },
  {
    title: '森林消防',
    sub: '火情预警 · 精准灭火 · 安全巡护',
    ...
    tags: ['精准灭火', '火情预警', '安全巡护'],
    link: '/homeCoreIndustries?module=forest-fire',
  },
  {
    title: '挂载系列适配',
    sub: '快速部署 · 无缝兼容 · 多场景覆盖',
    ...
    link: '/homeCoreIndustries?module=mount-adapt',
  },
  {
    title: '清洗系列',
    ...
    tags: ['光伏电站', '风电叶片', '桥梁检测'],
    link: '/homeCoreIndustries?module=high-cleaning',
  },
  {
    title: '固定翼巡检系列',
    sub: '长航时 · 模块化 · 快速部署',
    ...
    tags: ['长距巡护', '全域航测', '高效作业'],
    link: '/homeCoreIndustries?module=fixed-wing',
  },
  {
    title: '系留系列',
    ...
    link: '/homeCoreIndustries?module=tethered',
  },
  {
    title: '科研定制服务',
    sub: '地质勘测 · 气象探测 · 生态调研',
    ...
    link: '/homeCoreIndustries?module=research',
  },
]);
