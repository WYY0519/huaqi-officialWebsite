...
/* 
become 变得
smart 聪明的 比较级 smarter 更聪明的
shadow 阴影，影子
low 低的，矮的 比较级 lower 更低的
countryside 乡下，乡村
kilogram 千克 公斤
both 两者，两个，都
than 比
...
hall 大厅，礼堂
dinosaur 恐龙
strong 强壮 比较级 stronger 更强壮的
small 小的 比较级 smaller 更小的 
big 大的 比较级 bigger 更大的 
heavy 重的 比较级 heavier 更重的
thin  薄/瘦的 比较级 thinner 更薄/瘦的
log 长的 比较级 loger 更长的
short 短的 比较级 shorter 更短的
tall 高的 比较级 taller 更高的
old 老的 比较级 older 更老的
young 年轻的 比较级 younger 更年轻的
*/
